export const locale = {
    ...
    data: {
        'about': {
            ...
            'years': 'Years',
            'graduation': "B.Tech, MBA",
            'myResearch': 'CargoFlash InfoTech Pvt. Ltd.',
        ...
        'education': {
            ...
            'masterDegreeOneDesc': "MBA (Marketing)",
            'bachlorDegree': "Bachelor's degree",
            'bachlorDegreeDesc': "B.Tech (CSE)",
            'university': 'Uttarakhand Technical University Dehradoon, IN',
            'mission':'Mission',
            ...
            'years':'years',
            'movies':'Movies',
            'watchMovies':' 12th Fail, Source Code, Hacker, 3 Idiots',
            'technology':'Learning',
            'technologyInterest':' New Technology',
        },
        'header': {
            'home': 'Home',
            'about': 'About',
